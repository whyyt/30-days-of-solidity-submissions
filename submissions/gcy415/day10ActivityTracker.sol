...
contract SimpleFitnessTracker{
    ...
    event ProfiledUpdated(address indexed userAddress, uint256 newWeight, uint256 timestamp);
    event WorkoutLogged(
    ...
    function updateWeight(uint256 _newWeight) public onlyRegistered{
        ...
        emit ProfiledUpdated(msg.sender, _newWeight, block.timestamp);
    }
