...
contract SimpleEscrow{
    ...
    function raiseDispute() external{
        ...
        require(state == EscrowState.AWAITING_DELIVERY, "Can not dispute now");
    ...
    function cancelAfterTimeout() external{
        ...
        require(state == EscrowState.AWAITING_DELIVERY, "Can not cancel in current state");
    ...
    function cancelMutual() external{
        require(msg.sender == buyer || msg.sender == seller, "Not authorized");
        require(state == EscrowState.AWAITING_DELIVERY || state == EscrowState.AWAITING_PAYMENT, "Can not cancel now");
