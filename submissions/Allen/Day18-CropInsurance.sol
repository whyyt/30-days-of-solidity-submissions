...
contract CropInsurance is Ownable {
    ...
    constructor(address _weatherOracle, address _ethUsdPriceFeed) payable Ownable(msg.sender) {
        ...
        // This is the address of a Chainlink price feed that gives us ETH → USD conversion.
    ...
    function purchaseInsurance() external payable {
        ...
        // Converting our $10 premium into ETH (multiplied by 1e18 = 10 ** 18 for wei precision).
