...
contract SimpleFitnessTracker {
    ...
    function registerUser(string memory _name, uint256 _weight)public {
        ...
        //Emit registration eventemit UserRegistred(msg.sender, _name, block.timestamp);
    }

    //Update user weight
    function updateWeght(uint256 _newWeight)public onlyRegistered{
