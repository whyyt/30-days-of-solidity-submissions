...
contract CropInsurance is Ownable {
    AggregatorV3Interface private weatherOracle;a
    AggregatorV3Interface private ethUsdPriceFeed;

    uint256 public constant RAINFALL_THRESHOLD = 500; //保险触发阈值：毫米
    uint256 public constant INSURANCE_PREMIUM_USD = 10; //保费：美元
    ...
    // 部署时传入天气预言机（MockWeatherOracle）和 ETH/USD 价格预言机（可以从测试网获取）的地址
    ...
    function purchaseInsurance() external payable {
        uint256 ethPrice = getEthPrice(); //wei
