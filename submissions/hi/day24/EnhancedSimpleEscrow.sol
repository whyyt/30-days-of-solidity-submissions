...
/// @title EnhancedSimpleEscrow - 具有超时、取消和事件的安全托管合约           //文档注释
contract EnhancedSimpleEscrow {//声明一个合约名为EnhancedSimpleEscrow
    enum EscrowState { AWAITING_PAYMENT, AWAITING_DELIVERY, COMPLETE, DISPUTED, CANCELLED } //枚举

    address public immutable buyer;//声明一个地址型变量名为buyer，公开可见，
